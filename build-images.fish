...
echo "inkscape -w 48 -h 48 $SVG -o dist/$NAME/favicon.png
...
inkscape -w 800 -h 800 -o dist/$NAME/$NAME-800.png $SVG" | parallel -j+0

echo "convert dist/$NAME/$NAME-400.png -gravity center -background \"$BACKGROUND\" -alpha background -flatten -extent 1920x1080 dist/$NAME/$NAME-background-2k.png
